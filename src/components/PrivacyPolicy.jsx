    ...
    return (
        <div className="container mx-auto px-4 py-12 bg-base-100 min-h-screen">
            ...
            <section className="mb-8 bg-base-200 p-6 rounded-lg shadow-md">
                <h2 className="text-3xl font-bold mb-4 text-gray-600">1. What information do we collect?</h2>
                ...
                <h3 className="text-xl font-semibold mb-2 text-gray-500">Personally identifiable information (PII):</h3>
                ...
                <h3 className="text-xl font-semibold mb-2 mt-4 text-gray-500">Non-personally identifiable information:</h3>
                <ul className="list-disc list-inside text-gray-500 ml-4 space-y-1">
            ...
            <section className="mb-8 bg-base-200 p-6 rounded-lg shadow-md">
                <h2 className="text-3xl font-bold mb-4 text-gray-500">2. How do we use your information?</h2>
                <p className="text-lg text-gray-500 leading-relaxed mb-4">
            ...
            <section className="mb-8 bg-base-200 p-6 rounded-lg shadow-md">
                <h2 className="text-3xl font-bold mb-4 text-gray-500">3. Disclosure of your information</h2>
                <p className="text-lg text-gray-500 leading-relaxed mb-4">
            ...
            <section className="mb-8 bg-base-200 p-6 rounded-lg shadow-md">
                <h2 className="text-3xl font-bold mb-4 text-gray-500">4. Cookies and tracking technology</h2>
                <p className="text-lg text-gray-500 leading-relaxed mb-4">
            ...
            <section className="mb-8 bg-base-200 p-6 rounded-lg shadow-md">
                <h2 className="text-3xl font-bold mb-4 text-gray-500">5. your right</h2>
                <p className="text-lg text-gray-500 leading-relaxed mb-4">
            ...
            <section className="mb-8 bg-base-200 p-6 rounded-lg shadow-md">
                <h2 className="text-3xl font-bold mb-4 text-gray-500">6. Children's privacy</h2>
                <p className="text-lg text-gray-500 leading-relaxed mb-4">
            ...
            <section className="bg-base-200 p-6 rounded-lg shadow-md">
                <h2 className="text-3xl font-bold mb-4 text-gray-500">7. Contact us</h2>
                <p className="text-lg text-gray-500 leading-relaxed mb-4">
