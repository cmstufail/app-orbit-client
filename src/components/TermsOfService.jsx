    ...
    return (
        <div className="container mx-auto px-4 py-12 bg-base-100 min-h-screen">
            ...
            <section className="mb-8 bg-base-200 p-6 rounded-lg shadow-md">
                <h2 className="text-3xl font-bold mb-4 text-gray-500">1. Role and acceptance</h2>
            ...
            <section className="mb-8 bg-base-200 p-6 rounded-lg shadow-md">
                <h2 className="text-3xl font-bold mb-4 text-gray-500">2. User account</h2>
            ...
            <section className="mb-8 bg-base-200 p-6 rounded-lg shadow-md">
                <h2 className="text-3xl font-bold mb-4 text-gray-500">3. Use of the Service</h2>
                <ul className="list-disc list-inside text-gray-500 ml-4 space-y-1">
            ...
            <section className="mb-8 bg-base-200 p-6 rounded-lg shadow-md">
                <h2 className="text-3xl font-bold mb-4 text-gray-500">4. Intellectual Property</h2>
                <ul className="list-disc list-inside text-gray-500 ml-4 space-y-1">
            ...
            <section className="mb-8 bg-base-200 p-6 rounded-lg shadow-md">
                <h2 className="text-3xl font-bold mb-4 text-gray-500">5. Third-party links</h2>
                <p className="text-lg text-gray-500 leading-relaxed">
            ...
            <section className="mb-8 bg-base-200 p-6 rounded-lg shadow-md">
                <h2 className="text-3xl font-bold mb-4 text-gray-500">6. Termination of service</h2>
                <ul className="list-disc list-inside text-gray-500 ml-4 space-y-1">
            ...
            <section className="mb-8 bg-base-200 p-6 rounded-lg shadow-md">
                <h2 className="text-3xl font-bold mb-4 text-gray-500">7. Disclaimer</h2>
                <p className="text-lg text-gray-500 leading-relaxed">
            ...
            <section className="mb-8 bg-base-200 p-6 rounded-lg shadow-md">
                <h2 className="text-3xl font-bold mb-4 text-gray-500">8. Limitation of Liability</h2>
                <p className="text-lg text-gray-500 leading-relaxed">
            ...
            <section className="bg-base-200 p-6 rounded-lg shadow-md">
                <h2 className="text-3xl font-bold mb-4 text-gray-500">9. Contact us</h2>
                <p className="text-lg text-gray-500 leading-relaxed mb-4">
