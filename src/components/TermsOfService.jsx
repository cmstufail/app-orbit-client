        ...
        <Container>
            <div className="py-12 bg-base-100 min-h-screen">
                ...
                <section className='mb-8 bg-base-200 p-6 rounded-lg shadow-md'>
                    <h2 className="text-3xl font-bold mb-4">1. Role and acceptance</h2>
                ...
                <section className="mb-8 bg-base-200 p-6 rounded-lg shadow-md">
                    <h2 className="text-3xl font-bold mb-4">2. User account</h2>
                ...
                <section className="mb-8 bg-base-200 p-6 rounded-lg shadow-md">
                    <h2 className="text-3xl font-bold mb-4">3. Use of the Service</h2>
                    <ul className="list-disc list-inside ml-4 space-y-1">
                ...
                <section className="mb-8 bg-base-200 p-6 rounded-lg shadow-md">
                    <h2 className="text-3xl font-bold mb-4">6. Termination of service</h2>
                    <ul className="list-disc list-inside ml-4 space-y-1">
                ...
                <section className="mb-8 bg-base-200 p-6 rounded-lg shadow-md">
                    <h2 className="text-3xl font-bold mb-4">7. Disclaimer</h2>
                    <p className="text-lg leading-relaxed">
