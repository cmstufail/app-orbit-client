  ...
  return (
    <div className="py-16 bg-base-100">
      <div className="container mx-auto px-4 text-center">
        <h2 className="text-4xl font-bold text-gray-800 mb-12">Join Our Thriving Community</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          <div className="flex flex-col items-center p-6 bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300">
            ...
            <h3 className="text-xl font-semibold text-gray-700 mb-2">Connect & Collaborate</h3>
          ...
          <div className="flex flex-col items-center p-6 bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300">
            ...
            <h3 className="text-xl font-semibold text-gray-700 mb-2">Inspire & Be Inspired</h3>
            <p className="text-gray-600 text-sm">
          ...
          <div className="flex flex-col items-center p-6 bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300">
            ...
            <h3 className="text-xl font-semibold text-gray-700 mb-2">Launch & Grow</h3>
            <p className="text-gray-600 text-sm">
        ...
        <Link to={targetPath} className="btn btn-lg btn-primary normal-case">
          {buttonText}
        </Link>
      </div>
    </div>
