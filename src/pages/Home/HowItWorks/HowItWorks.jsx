    ...
    return (
        <div className="py-16 bg-gradient-to-br from-blue-50 to-indigo-100">
            <div className="container mx-auto px-4 text-center">
                <h2 className="text-4xl font-bold text-gray-800 mb-12">How AppOrbit Works</h2>

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {/* Join Community */ }
                    <div className="card bg-white shadow-lg rounded-lg p-6 transform transition-transform duration-300 hover:scale-105 hover:shadow-xl">
                        <div className="text-primary text-5xl mb-4 mx-auto w-fit p-3 bg-blue-100 rounded-full">
                            <FaUserPlus />
                        </div>
                        <h3 className="text-xl font-semibold text-gray-700 mb-3">1. Join Our Community</h3>
                    ...
                    <div className="card bg-white shadow-lg rounded-lg p-6 transform transition-transform duration-300 hover:scale-105 hover:shadow-xl">
                        ...
                        <h3 className="text-xl font-semibold text-gray-700 mb-3">2. Discover & Upvote</h3>
                        <p className="text-gray-600 text-sm">
                    ...
                    <div className="card bg-white shadow-lg rounded-lg p-6 transform transition-transform duration-300 hover:scale-105 hover:shadow-xl">
                        ...
                        <h3 className="text-xl font-semibold text-gray-700 mb-3">3. Share Your Products</h3>
                        <p className="text-gray-600 text-sm">
                    ...
                    <div className="card bg-white shadow-lg rounded-lg p-6 transform transition-transform duration-300 hover:scale-105 hover:shadow-xl">
                        ...
                        <h3 className="text-xl font-semibold text-gray-700 mb-3">4. Unlock Premium</h3>
                        <p className="text-gray-600 text-sm">
